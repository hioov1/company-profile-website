...
export default function AboutPage() {
  return (
    <motion.section className="relative h-screen overflow-hidden" initial="hidden" animate="show">
      {/* Split backgrounds */}
      <div className="absolute inset-y-0 left-0 w-1/3 bg-black" />
      <div className="absolute inset-y-0 right-0 w-1/2 bg-white" />

      <div className="relative flex h-full">
        {/* Gambar (slide in from left) */}
